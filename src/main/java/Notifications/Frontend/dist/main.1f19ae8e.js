...
messaging.requestPermission().then(function () {
  ...
  return messaging.getToken({
    vapidKey: "BD5JydjGtsn8MnsWWOupsPrUo1jLhlJxjV_IiTezld5pEy8UoegJU5k_9fow5MwGi6zWhEaoAKesneofHErfUGc"
  });
}).then(function (token) {
  currentToken = token;
  console.log(token);
  ...
  fetch('http://127.0.0.1:8080/', options).then(function (res) {
    return res.json();
  }).then(function (res) {
...
},{"/home/vm/Scalable/src/firebase-messaging-sw.js":[["firebase-messaging-sw.js","firebase-messaging-sw.js"],"firebase-messaging-sw.js.map","firebase-messaging-sw.js"]}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
