...
public class NotifyAllInstructorsCommand extends CommandDP {
    ...
    public JSONObject execute() {
        ...
        ArrayList<Document> instructors = mongoDB.readAll(mongoClient,Collections.register,filterDocument, Sorts.ascending(sort),skip,limit,jedis);
